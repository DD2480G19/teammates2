...
public class SubmitFeedbackResponsesActionTest extends BaseActionTest<SubmitFeedbackResponsesAction> {
    ...
    public void testExecute_studentSubmission_giverIdentifierShouldBeTeamName() throws Exception {
        ...
        FeedbackResponsesRequest.FeedbackResponseRequest resReq = new
                FeedbackResponsesRequest.FeedbackResponseRequest(student1InCourse1.getEmail(), resDet);
        ...
        verifyGiverTypeIsTeamName(student1InCourse1, actualResponse);
    }
    ...
    public void testAccessControl_studentDoesNotExist_shouldThrowEntityNotFoundException() throws Exception {
        int questionNumber = 1;
        FeedbackSessionAttributes sessionNoStudent = typicalBundle.feedbackSessions.get("sessionInTestingWithoutStudent");
        String feedbackSessionName = sessionNoStudent.getFeedbackSessionName();
        String courseId = sessionNoStudent.getCourseId();
